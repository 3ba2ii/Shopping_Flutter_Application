  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Container(
            color: Color.fromRGBO(244, 246, 246, 1).withOpacity(1),
          ),
                ...
                children: <Widget>[
                  Flexible(
                    child: Container(
                      ...
                      child: Image.network(
                        'https://i.ibb.co/M9DQFSq/shop.png',
                        scale: 3,
                      ),
                    ),
                  ),
